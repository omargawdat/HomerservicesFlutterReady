import 'package:untitled1/animation/FadeAnimation.dart';
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.network(_exteraCleaning[index][1],
                                height: 40),
                            SizedBox(height: 10),
                            Text(_exteraCleaning[index][0],
                                style: TextStyle(
                                    fontSize: 15,
